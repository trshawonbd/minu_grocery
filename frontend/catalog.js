...
const DISPLAY_CATEGORIES = [
  ...
  { id: "piimajoogid", sources: ["Milk drinks & drinking yoghurt"], icon: "bottle", name: { et: "Piimajoogid ja joogijogurtid", en: "Milk drinks & drinking yoghurt", ru: "Молочные напитки" } },
  { id: "kohukesed", sources: ["Curd snacks & desserts"], icon: "bowl", name: { et: "Kohukesed ja magustoidud", en: "Curd snacks & desserts", ru: "Сырки и десерты" } },
  ...
  { id: "nakileivad", sources: ["Crispbreads"], icon: "bread", name: { et: "Näkileivad", en: "Crispbreads", ru: "Хлебцы" } },
  ...
  { id: "puljongid", sources: ["Broths & stock"], icon: "bowl", name: { et: "Puljongid", en: "Broths & stock", ru: "Бульоны" } },
  ...
  { id: "kulmutatud-kala", sources: ["Frozen fish & seafood"], icon: "fish", name: { et: "Külmutatud kala", en: "Frozen fish & seafood", ru: "Замороженная рыба" } },
  { id: "kulmutatud-taignad", sources: ["Frozen dough & pastries"], icon: "cake", name: { et: "Külmutatud taignad ja saiakesed", en: "Frozen dough & pastries", ru: "Замороженное тесто и выпечка" } },
  ...
  { id: "siirupid", sources: ["Syrups & juice drinks"], icon: "cup", name: { et: "Siirupid ja mahlajoogid", en: "Syrups & juice drinks", ru: "Сиропы и соковые напитки" } },
  { id: "energiajoogid", sources: ["Energy, sports & iced-tea drinks"], icon: "cup", name: { et: "Energia- ja spordijoogid, jäätee", en: "Energy, sports & iced tea", ru: "Энергетики, спортивные напитки, холодный чай" } },
