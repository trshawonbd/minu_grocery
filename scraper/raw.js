...
function writeRaw(category, { order, strictPackaging, matchAcrossWeights, diaperMatching, impliedDescriptors = [], resultsByStore }, { dir = RAW_DIR, fetchedAt = new Date().toISOString() } = {}) {
  ...
  writeJson(path.join(categoryDir, "meta.json"), { category, order, strictPackaging, matchAcrossWeights, diaperMatching, impliedDescriptors, fetchedAt });
}
